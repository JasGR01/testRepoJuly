...
print("because weapon is a child of parent class spaceship of which falcon is instance of so, falcon can not inherite methods or properties of child class but child class can")
